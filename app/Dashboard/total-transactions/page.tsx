...
export const totalTransactionsData: TransactionData[] = [
...
const TotalTransactions = () => {
  ...
  const transactionData: TransactionData[] = useMemo(() => totalTransactionsData, [])
...
export const LatestTotalTransactions: React.FC = () => {
  const latestTransactionData = totalTransactionsData
