...
export const customerToCustomerData: TransactionData[] = [
...
const CustomerToCustomer = () => {
  ...
  const transactionData: TransactionData[] = useMemo(() => customerToCustomerData, [])
...
export const LatestCustomerToCustomer: React.FC = () => {
  const latestTransactionData = customerToCustomerData
