...
export const vendorToCustomersData: TransactionData[] = [
...
const VendorToCustomers = () => {
  ...
  const transactionData: TransactionData[] = useMemo(() => vendorToCustomersData, [])
...
export const LatestVendorToCustomers: React.FC = () => {
  const latestTransactionData = vendorToCustomersData
  ...
  return (
    <Link href="/Dashboard/vendor-to-customers">
      <Card className="bg-white shadow-md cursor-pointer">
        <CardHeader>
          <CardTitle>Vendor to Customers</CardTitle>
          <CardDescription>Newest 3 transactions from vendors to customers</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
